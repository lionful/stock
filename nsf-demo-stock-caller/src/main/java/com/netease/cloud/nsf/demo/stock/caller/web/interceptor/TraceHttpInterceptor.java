package com.netease.cloud.nsf.demo.stock.caller.web.interceptor;
...
public class TraceHttpInterceptor implements ClientHttpRequestInterceptor {
	...
	public ClientHttpResponse intercept(HttpRequest request, byte[] body, ClientHttpRequestExecution execution)
		...
		if(!AuthManager.isEmpty()) {
			AuthToken token = AuthManager.getAuthToken();
			request.getHeaders().add(AuthToken.TOKEN_KEY, token.getTokenId());
		}
